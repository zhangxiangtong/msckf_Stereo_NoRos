...
class MsckfVio {
  public:
    ...
    // Constructor
    MsckfVio(std::string dataSetConfig,std::string paramconfigfile,VioDrawer *pvioDrawer);
     ...
     */
    bool initialize(std::string dataSetConfig,std::string paramconfigfile);
  ...
  public:
     ...
     */
    bool loadParameters(std::string dataSetConfig,std::string paramconfigfile);
     ...
     * @param msg IMU msg.
     */
    bool imuCallback(std::vector<IMU> &vImu);
     ...
     */
    void featureCallback(const Frame_Feature& frameFeature);
    ...
    void addFeatureObservations(const Frame_Feature& frameFeatures);
...
public:
    double initial_gyro_bias_cov;
    double initial_acc_bias_cov;
    double initial_velocity_cov;
    double initial_extrinsic_rotation_cov;
    double initial_extrinsic_translation_cov;
